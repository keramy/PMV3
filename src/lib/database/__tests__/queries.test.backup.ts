...
describe('User & Authentication Queries', () => {
  // Access the mocked Supabase clients from setup.ts
  ...
  describe('getCurrentUserProfile', () => {
    ...
    it('should return transformed user profile when user is authenticated', async () => {
      ...
      // Mock the createTypedQuery to return a mock that can be controlled
...
describe('Project Queries', () => {
  ...
  describe('getCompanyProjects', () => {
    ...
    it('should apply status filter', async () => {
      ...
      await getCompanyProjects(1, 10, { status: 'active' })

      // Just verify the function completed successfully
      expect(mockQuery.mockResolvedValue).toHaveBeenCalled()
    })
    ...
    it('should apply search filter', async () => {
      ...
      await getCompanyProjects(1, 10, { search: 'test' })
...
describe('Task Queries', () => {
  ...
  describe('getTasks', () => {
    ...
    it('should apply project filter', async () => {
      ...
      await getTasks({ projectId: 'project-123' })
  ...
  describe('getOverdueTasks', () => {
    ...
    it('should apply project filter for overdue tasks', async () => {
      ...
      await getOverdueTasks('project-123')
...
describe('Construction Workflow Queries', () => {
  ...
  describe('getScopeItems', () => {
    ...
    it('should apply category filter', async () => {
      ...
      await getScopeItems('project-123', 'electrical')

      expect(mockQuery.eq).toHaveBeenCalledWith('category', 'electrical')
    })
  })
  ...
  describe('getShopDrawings', () => {
    it('should fetch shop drawings for project', async () => {
      ...
      expect(mockSupabase.from).toHaveBeenCalledWith('shop_drawings')
      expect(mockQuery.eq).toHaveBeenCalledWith('project_id', 'project-123')
    ...
    it('should apply status filter', async () => {
      ...
      await getShopDrawings('project-123', 'approved')
  ...
  describe('getRFIs', () => {
    it('should fetch RFIs for project', async () => {
      ...
      expect(mockSupabase.from).toHaveBeenCalledWith('rfis')
      expect(mockQuery.eq).toHaveBeenCalledWith('project_id', 'project-123')
  ...
  describe('getMaterialSpecs', () => {
    it('should fetch material specs for project', async () => {
      ...
      expect(mockSupabase.from).toHaveBeenCalledWith('material_specs')
      expect(mockQuery.eq).toHaveBeenCalledWith('project_id', 'project-123')
